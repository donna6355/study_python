...
<body>
	...
	for (int i = 0; i < list.size(); i++) {
		...
		tBody += "<tr><td>" + data.getIdx() + "</td><td><a href='boardContent.do?idx=" + data.getIdx() + "'>"
		+ data.getTitle() + "</a></td><td>" + data.getWriter() + "</td><td>" + data.getIndate() + "</td><td>"
		+ data.getCount() + "</td></tr>";
	}
	%>
	...
	<div class="container">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<%} else { %>
				<button onclick="alert('login first')" class="btn btn-primary">Write</button>
				<%} %>
			</div>
